...
We don't want to look at a table that is 1000's of rows long, let's make a graph!
...
There are more fun ways to visualize word counts than a graph!
...
create_SW_Wordcloud(chosen_side)
